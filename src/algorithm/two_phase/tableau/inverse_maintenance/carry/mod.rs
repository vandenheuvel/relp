    ...
    BI: BasisInverse<F=F>,
{
    ...
    fn change_basis(
        ...
        let w = self.basis_inverse.right_multiply_by_basis_inverse::<Self::F, SparseSliceIterator<Self::F>>(iter);
        ...
        let y = self.basis_inverse.right_multiply_by_basis_inverse(column.iter()).into_column();
